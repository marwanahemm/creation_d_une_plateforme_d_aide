    ...
    <aside className="mt-6 bg-slate-50 border border-slate-200 rounded-2xl p-5 text-center">
      ...
      <div className="flex justify-center gap-3">
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold border-2 border-green-300 text-green-800 bg-green-100 hover:bg-green-600 hover:text-white hover:border-green-600 transition-all duration-200 disabled:opacity-50"
        >
          <ThumbsUp size={16} /> Oui, utile
        </button>
        <button
          onClick={() => handleVote(false)}
          disabled={loading}
          className="flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold border-2 border-red-300 text-red-800 bg-red-100 hover:bg-red-600 hover:text-white hover:border-red-600 transition-all duration-200 disabled:opacity-50"
        >
